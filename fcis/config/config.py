...
config.network.pretrained = './model/pretrained_model/resnet_v1_101'
...
config.dataset.CLASSES = ['aeroplane', 'bicycle', 'bird', 'boat',
...
def update_config(config_file):
    ...
    with open(config_file) as f:
        ...
        cls = config.dataset.CLASSES
        cls = ['__background__'] + [c for c in cls if c.lower() != '__background__']
        config.dataset.CLASSES = cls
        config.dataset.NUM_CLASSES = len(cls)